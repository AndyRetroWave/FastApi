...
class IncorrectRefreshTokenException(BookingException):
    status_code = status.HTTP_401_UNAUTHORIZED
    detail = "Неправильный токен или емайл!"
...
class AdminAccessExpireException(BookingException):
    status_code = status.HTTP_401_UNAUTHORIZED
    detail = "У вас нет Административного доступа!"
...
class TokenRefreshAsentException(BookingException):
    status_code = status.HTTP_401_UNAUTHORIZED
    detail = "Неправильный обновляемый"
